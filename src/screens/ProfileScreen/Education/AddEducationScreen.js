...
const AddEducationScreen = () => {
  ...
  const [field, setField] = useState("Computer kkk");
    ...
    <View style={{ flex: 1 }}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-evenly" }}>
        ...
        >
          ...
          >
            <View style={styles.modalView}>
              <Text style={styles.modalText}>surd орсон жил</Text>
              <Picker
